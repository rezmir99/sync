[
{
  "remarks": "#0 WORKER6.TLS 2025-03-10",
  "log": {
    "access": "",
    "error": "",
    "loglevel": "warning"
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          ...
          "serverName": "weathered-smoke-a384.jegakey970.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "wild-haze-9154.kehave6570.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "silent-boat-937c.mepepek404.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "spring-sunset-c9a5.coxiy35895.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "odd-brook-2707.kexenen3585.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "dawn-shadow-6d5b.fivon81984.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "sparkling-sun-d87c.yenel5385.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "odd-frost-a8cc.jawic89245.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "long-bonus-716a.wimat94374.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "tlsSettings": {
          "allowInsecure": false,
          "fingerprint": "randomized",
          "serverName": "restless-leaf-82b6.laton16859.workers.dev",
          "show": false,
          "alpn": [
            "http/1.1"
          ]
...
,
{
  "remarks": "#1 WORKER6.TLS 2025-03-10",
  "log": {
    "access": "",
    "error": "",
    "loglevel": "warning"
